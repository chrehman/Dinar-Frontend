...
const Card = ({banner,title,description ,...props}) => {
    return (
        <div className='h-full bg-white w-full mb-5 hover:scale-[1.03] hover:border-[#e2dcd5] hover:border-r-4 hover:border-b-4' {...props}>
